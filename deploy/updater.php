    ...
    $response = json_decode(
        ...
        wp_remote_retrieve_body(
            ...
            wp_remote_get(
                ...
                'https://raw.githubusercontent.com/Ragapriyaait/wp-gravity-forms-extension/master/version.json'
...

{
    ...
    $GLOBALS['wpme_gravity_downloadLink'] =

        'https://github.com/Ragapriyaait/wp-gravity-forms-extension/archive/master.zip';
    ...
    add_action('admin_init', function () use ($file) {
        ...
        $GLOBALS['wpme_gravity_active'] = is_plugin_active(

            $GLOBALS['wpme_gravity_basename']
    ...
    add_filter(
        ...
        function ($transient) use ($file, $version) {
            ...
            if ($transient && property_exists($transient, 'checked')) {
                ...
                if (
                    ...
                    $checked =
                        ...
                        isset($GLOBALS['wpme_gravity_plugin'])
                    ...
                    $version =
                        ...
                        $version === null
                            ...
                            ? wpme_gravity_forms_get_github_version()
                    ...
                    $out_of_date = version_compare(
                        ...
                        $GLOBALS['wpme_gravity_plugin']['Version'],
                    ...
                    if ($out_of_date) {
                        ...
                        $slug = current(
                            ...
                            explode('/', $GLOBALS['wpme_gravity_basename'])
                        ...
                        $plugin = [
                            ...
                            'url' => isset(
                                ...
                                $GLOBALS['wpme_gravity_plugin']['PluginURI']
    ...
    add_filter(
        ...
        function ($result, $action, $args) use ($file, $version) {
            ...
            if (!empty($args->slug)) {
                ...
                if (
                    ...
                    current(explode('/', $GLOBALS['wpme_gravity_basename']))
                    ...
                    $plugin = [
                        ...
                        'author' =>
                            ...
                            $GLOBALS['wpme_gravity_plugin']['AuthorName'],

                        'author_profile' =>

                            $GLOBALS['wpme_gravity_plugin']['AuthorURI'],
                        ...
                        'short_description' =>
                            ...
                            $GLOBALS['wpme_gravity_plugin']['Description'],
    ...
    add_filter(
        ...
        function ($response, $hook_extra, $result) use ($file) {
            ...
            if ($GLOBALS['wpme_gravity_active']) {
                ...
                custom_logs("dddddddddddddcccccccccc");
    ...
    function custom_logs($message)
{
    ...
    echo fwrite(
        $file,
        "\n" . date('Y-m-d h:i:s') . ' :: ' . 'sssssssssssssssssssssssssssssss'
    );
